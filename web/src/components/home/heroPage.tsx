    ...
    <div className="my-[100px]">
      <div className="flex flex-col gap-[100px]">
        <div className="container mx-auto flex flex-col gap-[30px] px-4">
          <div className="container mx-auto flex justify-between px-4">
            <div className="rounded-[10px] bg-[#E0E0E0] pt-[186px]">
              <img src="/images/home/hero/hero-1.png" alt="hero-1" />
            </div>
            <div className="flex flex-col gap-[35px]">
              <div className="rounded-[10px] bg-[#E0E0E0] px-[15px] pt-1.5">
                <img src="/images/home/hero/hero-2.png" alt="hero-2" />
              </div>
              ...
              <div className="">
                <img src="/images/home/hero/hero-3.png" alt="hero-3" />
              </div>
            </div>
            <div className="rounded-[10px] bg-[#E0E0E0] pt-[188px] pr-20 pl-[63px]">
              <img src="/images/home/hero/hero-4.png" alt="hero-4" />
            </div>
          </div>
        ...
        <div className="container mx-auto flex items-center justify-between px-5">
          <img src="/images/home/model-logos/chanel.png" alt="chanel" />
          <img src="/images/home/model-logos/louis-vuitton.png" alt="louis-vuitton" />
          <img src="/images/home/model-logos/prada.png" alt="prada" />
          <img src="/images/home/model-logos/calvin-klein.png" alt="calvin-klein" />
          <img src="/images/home/model-logos/denim.png" alt="denim" />
        </div>
      </div>
    </div>
  );
