...
const MainProduct: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="min-h:[600px] relative mt-[150px] w-full overflow-hidden">
        <div className="absolute inset-0">
          <svg className="h-full w-full" preserveAspectRatio="none" viewBox="0 0 1000 1000">
            <polygon points="0,0 500,0 450,1000 0,1000" fill="#F8F8F8" />

            <polygon points="500,0 1000,0 1000,1000 450,1000" fill="#DADADA" />

            <line x1="500" y1="0" x2="450" y2="1000" stroke="black" strokeWidth="2" />
          </svg>
        </div>
        ...
        <div className="relative z-10 grid min-h-[600px] grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative flex flex-col items-start justify-center gap-5 px-12 py-16 lg:px-20">
            ...
            <h1 className="text-[46px] leading-tight font-normal text-[#484848]" style={{ fontFamily: "Volkhov" }}>
              {product.name}
            </h1>
            ...
            <p
              className="max-w-[515px] text-base leading-relaxed font-normal text-[#767676]"
            ...
            <div className="flex items-center gap-3.5">
              ...
              <span
                className="rounded-[10px] bg-black px-5 py-1.5 text-base font-normal text-white"
                style={{ fontFamily: "Poppins" }}
              >
                {product.size}
              </span>
            ...
            <div className="flex items-end gap-[0.25px]">
              <span className="text-[28px] leading-none font-medium" style={{ fontFamily: "Poppins" }}>
                {product.priceCurrency}
              </span>
              <span className="text-[28px] leading-none font-medium" style={{ fontFamily: "Poppins" }}>
                {product.price}
              </span>
              <span className="text-[24px] leading-none font-medium" style={{ fontFamily: "Poppins" }}>
                {product.priceCent}
              </span>
            </div>
            ...
            <button
              className="cursor-pointer rounded-[10px] bg-black px-[70px] py-5 text-base font-normal text-white transition-colors hover:bg-gray-800"
              style={{ fontFamily: "Poppins" }}
            >
              Buy Now
            </button>
      ...
      <div className="container mx-auto flex w-full flex-wrap justify-between gap-8 px-6 py-[70px] lg:flex-nowrap">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            <p className="text-xl leading-tight font-medium text-[#484848]" style={{ fontFamily: "Poppins" }}>
              High Quality
            </p>
            <span className="text-base leading-relaxed font-normal text-[#484848]" style={{ fontFamily: "Poppins" }}>
