        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {cart.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="mb-2 text-lg font-medium text-gray-600" style={{ fontFamily: "Poppins" }}>
                Your cart is empty
              </p>
              <p className="mb-6 text-sm text-gray-500" style={{ fontFamily: "Poppins" }}>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                      ...
                      <div className="flex flex-1 flex-col justify-between">
                        <div>
                          <Link to={`/product/${item._id}`}>
                            <h3
                              className="mb-2 text-base font-semibold text-gray-900 hover:text-gray-600"
                              style={{ fontFamily: "Poppins" }}
                            >
                              {item.name}
                            </h3>
                          </Link>
                          <div className="mb-3 flex gap-4 text-sm text-gray-600" style={{ fontFamily: "Poppins" }}>
                            {item.selectedColor && <span>Color: {item.selectedColor}</span>}
                            {item.selectedSize && <span>Size: {item.selectedSize}</span>}
                          </div>
                          <p className="text-lg font-bold text-gray-900" style={{ fontFamily: "Poppins" }}>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3 rounded-lg border border-gray-300 bg-white px-3 py-2">
                            ...
                            <span
                              className="min-w-8 text-center font-semibold text-gray-900"
                              style={{ fontFamily: "Poppins" }}
                            >
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 rounded-lg border border-gray-200 bg-gray-50 p-6 shadow-sm">
                  <h2 className="mb-4 text-xl font-semibold text-gray-900" style={{ fontFamily: "Volkhov" }}>
                    Order Summary
                  </h2>
                  ...
                  <div className="border-b border-gray-200 py-4">
                    <label className="flex cursor-pointer items-start gap-3" style={{ fontFamily: "Poppins" }}>
                      <input
                        ...
                        className="mt-1 h-4 w-4 cursor-pointer rounded accent-black"
                      />
                  ...
                  <div className="mt-4 mb-6 flex justify-between text-lg font-bold" style={{ fontFamily: "Poppins" }}>
                  ...
                  <Link
                    to="/checkout"
                    className="mb-3 block w-full rounded-lg bg-black py-3 text-center font-semibold text-white transition-all hover:bg-gray-800 hover:shadow-lg"
                    style={{ fontFamily: "Poppins" }}
                  >
                    Proceed to Checkout
                  </Link>
                  ...
                  <Link
                    to="/shop"
                    className="block w-full text-center text-sm font-medium text-gray-600 underline transition-colors hover:text-gray-900"
                    style={{ fontFamily: "Poppins" }}
                  >
                    Continue Shopping
                  </Link>
